...
var Swiper = function (selector, params) {
    ...
    function onTouchStart(event) {
        ...
        if (!isTouchEvent || event.targetTouches.length == 1 ) {
            ...
            //CallBack
            if (params.onTouchStart) params.onTouchStart(_this, event); //hungvv
    ...
    function onTouchMove(event) {
        ...
        if (!isTouchEvent || event.touches.length == 1) {
            ...
            if (params.onTouchMove) params.onTouchMove(_this, event);   //hungvv
    ...
    function onTouchEnd(event) {
        ...
        if (!_this.isMoved) {
            _this.isMoved = false;
            if (params.onTouchEnd) params.onTouchEnd(_this, event)  //hungvv
        ...
        if (params.onTouchEnd) params.onTouchEnd(_this, event); /*add param event*/
        _this.callPlugins('onTouchEnd');
    }
    ...
    var isLock = false;
    _this.setLock = function(value){
        isLock = value;
    }
    _this.getLock = function(){
        return isLock;
    }
    makeSwiper();
}
